...
impl Portfolio {
    ...
    /// #     .build()
    /// #     .unwrap());
    /// # portfolio.positions.push(Position::new("POS_1", "ACME", "DEP", Arc::clone(&instrument), 1.0, PositionUnit::Units));
    ...
    /// #     .build()
    /// #     .unwrap());
    /// # portfolio.positions.push(Position::new("POS_1", "ENTITY_A", "DEP", Arc::clone(&instrument), 1.0, PositionUnit::Units));
