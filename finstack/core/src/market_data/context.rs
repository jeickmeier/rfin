...
// Note: This MarketContext uses trait object storage and does not support
// complete serialization. For full serialization support, use:
// finstack_core::market_data::context_v2::MarketContext
