...
mod tests {
    ...
    fn test_parse_normalized_enum_ok() {
        assert_eq!(parse_normalized_enum::<TestEnum>("foo").unwrap(), TestEnum::Foo);
        assert_eq!(parse_normalized_enum::<TestEnum>("FOO").unwrap(), TestEnum::Foo);
        assert_eq!(parse_normalized_enum::<TestEnum>("Bar").unwrap(), TestEnum::Bar);
        assert_eq!(parse_normalized_enum::<TestEnum>("b").unwrap(), TestEnum::Bar);
    }
