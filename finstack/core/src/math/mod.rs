...
pub use distributions::{binomial_probability, log_binomial_coefficient, log_factorial, sample_beta};
...
pub use special_functions::{erf, norm_cdf, norm_pdf, standard_normal_cdf, standard_normal_inv_cdf};
