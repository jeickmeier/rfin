...
fn test_holiday_calendar_trait() {
    let cal = TestCal::new()
        .with_holiday(make_date(2025, 1, 1)); // New Year's Day (Wednesday)
...
fn test_adjust_following() {
    let cal = TestCal::new()
        .with_holiday(make_date(2025, 1, 2)); // Thursday holiday
...
fn test_adjust_preceding() {
    let cal = TestCal::new()
        .with_holiday(make_date(2025, 1, 3)); // Friday holiday
...
fn test_adjust_modified_following() {
    ...
    let result = adjust(jan30, BusinessDayConvention::ModifiedFollowing, &cal_with_holiday);
...
fn test_adjust_modified_preceding() {
    let cal = TestCal::new()
        .with_holiday(make_date(2025, 2, 3)); // Monday holiday
