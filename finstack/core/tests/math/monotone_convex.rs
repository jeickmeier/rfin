use finstack_core::math::interp::{ExtrapolationPolicy, InterpFn, MonotoneConvex};
...
fn monotone_convex_basic_properties() {
    ...
    let interp = MonotoneConvex::new(knots, dfs.clone(), ExtrapolationPolicy::default())
        .expect("failed to build interp");
