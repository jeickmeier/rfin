...
use finstack_core::market_data::term_structures::credit_index::{CreditIndexData, CreditIndexDataBuilder};
...
fn credit_index_builder_supports_issuer_curves() {
    ...
    issuers.insert("IssuerA".to_string(), Arc::new(sample_hazard_curve("IssuerA")));
