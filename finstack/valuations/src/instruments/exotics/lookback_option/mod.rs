...
//! - See [`models::closed_form::lookback`](crate::instruments::common_impl::models::closed_form::lookback)
//!
//! # References
//!
...
//! - [`models::closed_form::lookback`](crate::instruments::common_impl::models::closed_form::lookback) for formulas
