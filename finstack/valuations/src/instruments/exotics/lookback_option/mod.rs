...
//! - See [`models::closed_form::lookback`](crate::instruments::models::closed_form::lookback)
//!
//! # References
//!
...
//! - [`models::closed_form::lookback`](crate::instruments::models::closed_form::lookback) for formulas
