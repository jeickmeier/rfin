...
impl FxSwap {
    ...
    pub fn example() -> Self {
        Self::builder()
            ...
            .near_date(Date::from_calendar_date(2024, time::Month::January, 5).expect("Valid example date"))
            .far_date(Date::from_calendar_date(2024, time::Month::July, 5).expect("Valid example date"))
