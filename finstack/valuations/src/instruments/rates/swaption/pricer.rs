            ...
            ModelKey::Black76 => {
                ...
                if swaption.sabr_params.is_some() {
                    ...
                    let vol_surface = market
                        ...
                        .map_err(|e| PricingError::missing_market_data_ctx(e.to_string(), PricingErrorContext::default()))?;
...
impl BermudanSwaptionPricer {
    ...
    /// use finstack_valuations::instruments::swaption::pricer::{BermudanSwaptionPricer, HullWhiteParams};
    /// use finstack_core::market_data::traits::Discounting;
    /// use std::sync::Arc;
    ///
    /// # fn main() -> finstack_core::Result<()> {
