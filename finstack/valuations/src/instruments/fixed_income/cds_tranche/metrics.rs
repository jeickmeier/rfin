...
use crate::instruments::fixed_income::cds_tranche::{CdsTranche, model::GaussianCopulaModel};
...
pub fn register_cds_tranche_metrics(registry: &mut MetricRegistry) {
    ...
    registry
        ...
        .register_metric(MetricId::custom("correlation_delta"), Arc::new(CorrelationDelta), &["CDSTranche"]);
}
