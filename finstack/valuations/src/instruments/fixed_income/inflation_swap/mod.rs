...
impl InflationSwap {
    /// Builder entrypoint
    pub fn builder() -> InflationSwapBuilder { InflationSwapBuilder::new() }
}
...
impl InflationSwapBuilder {
    ...
    pub fn build(self) -> finstack_core::Result<InflationSwap> {
        Ok(InflationSwap {
            ...
            start: self.start.ok_or_else(|| finstack_core::Error::from(finstack_core::error::InputError::Invalid))?,
            maturity: self.maturity.ok_or_else(|| finstack_core::Error::from(finstack_core::error::InputError::Invalid))?,
            fixed_rate: self.fixed_rate.ok_or_else(|| finstack_core::Error::from(finstack_core::error::InputError::Invalid))?,
            inflation_id: self.inflation_id.ok_or_else(|| finstack_core::Error::from(finstack_core::error::InputError::Invalid))?,
