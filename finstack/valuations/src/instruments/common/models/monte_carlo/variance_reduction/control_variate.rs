...
//! use [`OnlineCovariance`](crate::instruments::common::models::monte_carlo::online_stats::OnlineCovariance)
//! to compute covariance incrementally:
//!
//! ```rust,ignore
//! use finstack_valuations::instruments::common::models::monte_carlo::online_stats::OnlineCovariance;
//!
