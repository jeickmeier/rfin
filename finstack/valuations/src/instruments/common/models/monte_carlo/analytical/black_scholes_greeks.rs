...
/// Compute d1 parameter for Black-Scholes formula; wrapper preserves (spot, strike, time, rate, div_yield, vol)
...
/// Compute d2 parameter for Black-Scholes formula; wrapper preserves local ordering
