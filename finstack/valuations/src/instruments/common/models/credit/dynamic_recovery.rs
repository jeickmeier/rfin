...
impl DynamicRecoverySpec {
    ...
    pub fn constant(recovery: f64) -> Self {
        Self {
    ...
    pub fn inverse_linear(base_recovery: f64, base_notional: f64) -> Self {
        Self {
            base_recovery,
            base_notional,
    ...
    pub fn inverse_power(base_recovery: f64, base_notional: f64, exponent: f64) -> Self {
        Self {
            base_recovery,
            base_notional,
    ...
    pub fn floored_inverse(base_recovery: f64, base_notional: f64, floor: f64) -> Self {
        Self {
            base_recovery,
            base_notional,
...
mod tests {
    ...
    fn inverse_power_softer_decline() {
        let spec = DynamicRecoverySpec::inverse_power(0.40, 100.0, 0.5);
