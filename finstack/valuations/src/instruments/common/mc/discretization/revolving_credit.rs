...
use super::super::process::revolving_credit::{InterestRateSpec, RevolvingCreditProcess};
use super::super::traits::Discretization;
use super::exact_hw1f::ExactHullWhite1F;
use super::qe_cir::QeCir;
...
impl RevolvingCreditDiscretization {
    ...
    /// Create from process (convenience method).
