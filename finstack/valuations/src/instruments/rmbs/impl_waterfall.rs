...
impl Rmbs {
    ...
    pub(super) fn generate_tranche_cashflows_rmbs(
        &self,
        ...
        let mut waterfall_engine = self.create_rmbs_waterfall_engine();
        ...
        while pay_date <= self.legal_maturity && pool_outstanding.amount() > 100.0 {
            ...
            // Apply PSA/SDA-based prepayments and defaults
    ...
    /// Create waterfall engine for RMBS
    pub(super) fn create_rmbs_waterfall_engine(&self) -> WaterfallEngine {
