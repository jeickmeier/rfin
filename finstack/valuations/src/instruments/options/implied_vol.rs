...
use crate::instruments::options::{black_scholes_common, OptionType};
...
impl ImpliedVolSolver {
    ...
    pub fn solve(
        ...
        // Initial guess
        let mut vol = self.initial_guess(market_price, spot, strike, r, t, q, option_type);
        ...
        for _i in 0..self.config.max_iterations {
            let (price, vega, volga) =
                self.price_vega_volga(vol, spot, strike, r, t, q, option_type);
            ...
            if vega.abs() < 1e-10 {
                ...
                return self.bisection_fallback(market_price, spot, strike, r, t, q, option_type);
            }
        ...
        self.bisection_fallback(market_price, spot, strike, r, t, q, option_type)
    }
    ...
    fn bisection_fallback(
        ...
        for _ in 0..50 {
            ...
            let (price, _, _) = self.price_vega_volga(mid, spot, strike, r, t, q, option_type);
...
mod tests {
    ...
    fn test_implied_vol_atm_call() {
        ...
        let solver = ImpliedVolSolver::new();
        let iv = solver
            .solve(market_price, spot, strike, r, t, q, OptionType::Call)
            .unwrap();
    ...
    fn test_implied_vol_otm_put() {
        ...
        let solver = ImpliedVolSolver::new();
        let iv = solver
            .solve(market_price, spot, strike, r, t, q, OptionType::Put)
            .unwrap();
    ...
    fn test_implied_vol_below_intrinsic() {
        ...
        let intrinsic =
            (spot * ((-q * t) as f64).exp() - strike * ((-r * t) as f64).exp()).max(0.0_f64);
