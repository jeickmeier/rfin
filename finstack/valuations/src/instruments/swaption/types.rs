...
impl Swaption {
    ...
    pub fn example() -> Self {
        Self {
            ...
            strike_rate: 0.03,
            expiry: Date::from_calendar_date(2025, time::Month::January, 15).expect("Valid example date"),
            swap_start: Date::from_calendar_date(2025, time::Month::January, 17).expect("Valid example date"),
            swap_end: Date::from_calendar_date(2030, time::Month::January, 17).expect("Valid example date"),
