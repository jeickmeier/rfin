//! CMBS waterfall implementation

use super::types::Cmbs;
...
impl Cmbs {
    ...
    pub(super) fn generate_tranche_cashflows_cmbs(
        &self,
        ...
        let mut waterfall_engine = self.create_cmbs_waterfall_engine();
        ...
        while pay_date <= self.legal_maturity && pool_outstanding.amount() > 100.0 {
            ...
            // Apply CMBS prepayment and default rates
    ...
    /// Create waterfall engine for CMBS
    pub(super) fn create_cmbs_waterfall_engine(&self) -> WaterfallEngine {
