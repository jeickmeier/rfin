...
fn preflight_step(
    step: &crate::calibration::v2::api::schema::CalibrationStepV2,
    quotes: &[crate::calibration::v2::domain::quotes::MarketQuote],
    ...
    match &step.params {
        ...
        StepParams::Hazard(p) => {
            ...
            for q in &credit_quotes {
                match q {
                    crate::calibration::v2::domain::quotes::CreditQuote::CDS {
                        entity,
                        recovery_rate,
                        currency,
                        spread_bp,
                    ...
                    crate::calibration::v2::domain::quotes::CreditQuote::CDSUpfront {
                        entity,
                        recovery_rate,
                        currency,
                        running_spread_bp,
        ...
        StepParams::BaseCorrelation(p) => {
            ...
            let credit_quotes: Vec<crate::calibration::v2::domain::quotes::CreditQuote> =
            ...
            for q in &credit_quotes {
                if let crate::calibration::v2::domain::quotes::CreditQuote::CDSTranche {
                    index,
                    attachment,
                    detachment,
                    conventions,
