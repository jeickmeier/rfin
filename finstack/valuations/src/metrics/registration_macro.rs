...
/// Simplified chaining version for instruments that prefer method chaining.
///
/// # Examples
///
/// ```rust,ignore
/// use finstack_valuations::register_metrics_chained;
///
/// register_metrics_chained! {
///     registry: my_registry,
...
/// ```
#[macro_export]
macro_rules! register_metrics_chained {
    (
        registry: $registry:expr,
        instrument: $instrument:expr,
        metrics: [
...
mod tests {
    ...
    #[test]
    fn test_register_metrics_chained_macro() {
        let mut registry = MetricRegistry::new();
        ...
        register_metrics_chained! {
            ...
            metrics: [
                (Delta, DummyCalculator),
                (Gamma, DummyCalculator),
            ]
        };

        // Verify metrics were registered
        assert!(registry.is_applicable(&MetricId::Delta, "TestInstrument2"));
        assert!(registry.is_applicable(&MetricId::Gamma, "TestInstrument2"));
    }
}
