...
pub fn create_standard_registry() -> MetricRegistry {
    MetricRegistryBuilder::new()
        ...
        // Structured Credit metrics (CLO, ABS, RMBS, CMBS)
        .metric(MetricId::Accrued)
        .for_instruments(&["CLO", "ABS", "RMBS", "CMBS"])
        .with_calculator(crate::instruments::common::structured_credit::metrics::AccruedCalculator)
        .metric(MetricId::DirtyPrice)
        .for_instruments(&["CLO", "ABS", "RMBS", "CMBS"])
        .with_calculator(crate::instruments::common::structured_credit::metrics::DirtyPriceCalculator)
        .metric(MetricId::CleanPrice)
        .for_instruments(&["CLO", "ABS", "RMBS", "CMBS"])
        .with_calculator(crate::instruments::common::structured_credit::metrics::CleanPriceCalculator)
        .metric(MetricId::WAL)
        .for_instruments(&["CLO", "ABS", "RMBS", "CMBS"])
        .with_calculator(crate::instruments::common::structured_credit::metrics::WalCalculator)
        .metric(MetricId::DurationMac)
        .for_instruments(&["CLO", "ABS", "RMBS", "CMBS"])
        .with_calculator(crate::instruments::common::structured_credit::metrics::MacaulayDurationCalculator)
        .metric(MetricId::DurationMod)
        .for_instruments(&["CLO", "ABS", "RMBS", "CMBS"])
        .with_calculator(crate::instruments::common::structured_credit::metrics::ModifiedDurationCalculator)
        .metric(MetricId::ZSpread)
        .for_instruments(&["CLO", "ABS", "RMBS", "CMBS"])
        .with_calculator(crate::instruments::common::structured_credit::metrics::ZSpreadCalculator)
        .metric(MetricId::Cs01)
        .for_instruments(&["CLO", "ABS", "RMBS", "CMBS"])
        .with_calculator(crate::instruments::common::structured_credit::metrics::Cs01Calculator)
        .metric(MetricId::SpreadDuration)
        .for_instruments(&["CLO", "ABS", "RMBS", "CMBS"])
        .with_calculator(crate::instruments::common::structured_credit::metrics::SpreadDurationCalculator)
        .metric(MetricId::Ytm)
        .for_instruments(&["CLO", "ABS", "RMBS", "CMBS"])
        .with_calculator(crate::instruments::common::structured_credit::metrics::YtmCalculator)
        .metric(MetricId::WAM)
        .for_instruments(&["CLO", "ABS", "RMBS", "CMBS"])
        .with_calculator(crate::instruments::common::structured_credit::metrics::WamCalculator)
        .metric(MetricId::CPR)
        .for_instruments(&["CLO", "ABS", "RMBS", "CMBS"])
        .with_calculator(crate::instruments::common::structured_credit::metrics::CprCalculator)
        .metric(MetricId::CDR)
        .for_instruments(&["CLO", "ABS", "RMBS", "CMBS"])
        .with_calculator(crate::instruments::common::structured_credit::metrics::CdrCalculator)
        .build()
}
