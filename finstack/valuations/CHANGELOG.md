...
- Deprecated old `extract_*_curves()` functions with migration guidance
- Updated call sites with `#[allow(deprecated)]` annotations
...
- **100% backward compatible**: Deprecated functions delegate to trait methods
