...
fn test_notional_par() {
    let json = include_str!("json_examples/notional_par.example.json");
    test_roundtrip::<CashflowEnvelope<NotionalPayload>>(json);
}

#[test]
fn test_notional_percent_per_period() {
    let json = include_str!("json_examples/notional_percent_per_period.example.json");
    test_roundtrip::<CashflowEnvelope<NotionalPayload>>(json);
}

#[test]
fn test_amortization_linear_to() {
    let json = include_str!("json_examples/amortization_linear_to.example.json");
    test_roundtrip::<CashflowEnvelope<AmortizationSpecPayload>>(json);
}

#[test]
fn test_amortization_step_remaining() {
    let json = include_str!("json_examples/amortization_step_remaining.example.json");
    test_roundtrip::<CashflowEnvelope<AmortizationSpecPayload>>(json);
}

#[test]
fn test_coupon_type_cash() {
    let json = include_str!("json_examples/coupon_type_cash.example.json");
    test_roundtrip::<CashflowEnvelope<CouponTypePayload>>(json);
}

#[test]
fn test_coupon_type_split() {
    let json = include_str!("json_examples/coupon_type_split.example.json");
    test_roundtrip::<CashflowEnvelope<CouponTypePayload>>(json);
}

#[test]
fn test_fixed_coupon_spec() {
    let json = include_str!("json_examples/fixed_coupon_spec.example.json");
...
fn test_floating_rate_spec() {
    let json = include_str!("json_examples/floating_rate_spec.example.json");
    test_roundtrip::<CashflowEnvelope<FloatingRateSpecPayload>>(json);
}

#[test]
fn test_floating_coupon_spec() {
    let json = include_str!("json_examples/floating_coupon_spec.example.json");
...
fn test_prepayment_model_constant() {
    let json = include_str!("json_examples/prepayment_model_constant.example.json");
    test_roundtrip::<CashflowEnvelope<PrepaymentModelSpecPayload>>(json);
}

#[test]
fn test_prepayment_model_psa_100() {
    let json = include_str!("json_examples/prepayment_model_psa_100.example.json");
...
fn test_default_model_constant() {
    let json = include_str!("json_examples/default_model_constant.example.json");
    test_roundtrip::<CashflowEnvelope<DefaultModelSpecPayload>>(json);
}

#[test]
fn test_default_model_sda_100() {
    let json = include_str!("json_examples/default_model_sda_100.example.json");
    test_roundtrip::<CashflowEnvelope<DefaultModelSpecPayload>>(json);
}

#[test]
fn test_default_event() {
    let json = include_str!("json_examples/default_event.example.json");
    test_roundtrip::<CashflowEnvelope<DefaultEventPayload>>(json);
}

#[test]
fn test_recovery_model_standard() {
    let json = include_str!("json_examples/recovery_model_standard.example.json");
    test_roundtrip::<CashflowEnvelope<RecoveryModelSpecPayload>>(json);
}

#[test]
fn test_fee_spec_fixed() {
    let json = include_str!("json_examples/fee_spec_fixed.example.json");
    test_roundtrip::<CashflowEnvelope<FeeSpecPayload>>(json);
}

#[test]
fn test_fee_spec_periodic_bps() {
    let json = include_str!("json_examples/fee_spec_periodic_bps.example.json");
    test_roundtrip::<CashflowEnvelope<FeeSpecPayload>>(json);
}

#[test]
fn test_fee_tier() {
    let json = include_str!("json_examples/fee_tier.example.json");
    test_roundtrip::<CashflowEnvelope<FeeTierPayload>>(json);
}

#[test]
fn test_schedule_params_usd_standard() {
    let json = include_str!("json_examples/schedule_params_usd_standard.example.json");
