...
fn test_trinomial_tree_pricing() {
    ...
    let price = price_convertible_bond(&bond, &market, ConvertibleTreeType::Trinomial(50)).unwrap();
...
fn test_binomial_vs_trinomial_convergence() {
    ...
    let bin_price =
        price_convertible_bond(&bond, &market, ConvertibleTreeType::Binomial(100)).unwrap();

    let tri_price =
        price_convertible_bond(&bond, &market, ConvertibleTreeType::Trinomial(100)).unwrap();
...
fn test_binomial_convergence_with_steps() {
    ...
    let price_20 =
        price_convertible_bond(&bond, &market, ConvertibleTreeType::Binomial(20)).unwrap();
...
fn test_trinomial_convergence_with_steps() {
    ...
    let _price_20 =
        price_convertible_bond(&bond, &market, ConvertibleTreeType::Trinomial(20)).unwrap();

    let price_50 =
        price_convertible_bond(&bond, &market, ConvertibleTreeType::Trinomial(50)).unwrap();
...
fn test_tree_pricing_with_low_steps() {
    ...
    let price = price_convertible_bond(&bond, &market, ConvertibleTreeType::Binomial(5)).unwrap();
...
fn test_tree_pricing_with_high_steps() {
    ...
    let price = price_convertible_bond(&bond, &market, ConvertibleTreeType::Binomial(200)).unwrap();
...
fn test_default_tree_type() {
    ...
    let price = price_convertible_bond(&bond, &market, ConvertibleTreeType::default()).unwrap();
