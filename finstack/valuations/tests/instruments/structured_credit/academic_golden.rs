...
fn test_warf_golden_moody_standard() {
    ...
    let test_cases = [
        (CreditRating::AAA, 1.0, "AAA"),
        (CreditRating::AA, 10.0, "AA"),
        (CreditRating::A, 40.0, "A"),
        (CreditRating::BBB, 260.0, "BBB"),
        (CreditRating::BB, 1350.0, "BB"),
        (CreditRating::B, 2720.0, "B"),
        (CreditRating::CCC, 6500.0, "CCC"),
        (CreditRating::CC, 8070.0, "CC"),
        (CreditRating::C, 10000.0, "C"),
        (CreditRating::D, 10000.0, "D"),
    ];

    for (rating, expected_factor, label) in test_cases {
        let actual_factor = moodys_warf_factor(rating);
