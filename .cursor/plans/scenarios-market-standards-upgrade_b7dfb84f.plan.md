...
- **10.3 Rollout and feature flags**
- Where behavior changes could affect existing consumers (e.g., hazard calibration mode, arbitrage enforcement), introduce feature flags or configuration toggles, with a plan to converge to stricter defaults over time.