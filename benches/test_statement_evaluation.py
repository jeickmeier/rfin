...
def create_100_node_model() -> ModelBuilder:
...
def add_sample_values(builder: ModelBuilder) -> None:
...
class TestStatementEvaluationBenchmarks:
    ...
    def test_bench_evaluate_100_node_model(self, benchmark: BenchmarkFixture) -> None:
    ...
    def test_bench_evaluate_small_model(self, benchmark: BenchmarkFixture) -> None:
    ...
    def test_bench_model_construction(self, benchmark: BenchmarkFixture) -> None:
    ...
    def test_bench_single_period_evaluation(self, benchmark: BenchmarkFixture) -> None:
        ...
        def get_period_values() -> dict[str, Any]:
