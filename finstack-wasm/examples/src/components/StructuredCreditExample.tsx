  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        if (clo) {
          try {
            const cloResult = registry.priceInstrument(clo, 'discounting', market, asOf, null);
            results.push({
              name: 'CLO 2024-1',
              type: 'Collateralized Loan Obligation',
              totalSize: 400_000_000,
        ...
        const absJson = JSON.stringify({
          ...
          payment_frequency: { count: 1, unit: 'months' },
        ...
        try {
          const absResult = registry.priceInstrument(abs, 'discounting', market, asOf, null);
          results.push({
        ...
        try {
          const rmbsResult = registry.priceInstrument(rmbs, 'discounting', market, asOf, null);
          results.push({
        ...
        try {
          const cmbsResult = registry.priceInstrument(cmbs, 'discounting', market, asOf, null);
          results.push({
