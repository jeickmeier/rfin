...
import { MarketContext, CurveKind, DiscountCurve, FsDate } from 'finstack-wasm';
...
export const CurveKindDemo: React.FC = () => {
  ...
  return (
    <div className="demo-section">
      ...
      <p>
        Demonstrates the new unified <code>getCurve()</code> method with dynamic dispatch via{' '}
        <code>CurveKind</code> enum.
      </p>
