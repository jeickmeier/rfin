...
fn main() -> Result<()> {
    ...
    for period in &model.periods {
        ...
        println!(
            "  {} | {} | {} to {}",
            period.id, period_type, period.start, period.end
        );
    }
    println!();
    ...
    let income_statement = ModelBuilder::new("FY2025 Income Statement")
        ...
        .value(
            ...
            &[
                (
                    PeriodId::quarter(2025, 1),
                    AmountOrScalar::scalar(8_000_000.0),
                ),
                (
                    PeriodId::quarter(2025, 2),
                    AmountOrScalar::scalar(8_500_000.0),
                ),
            ],
        )
        .value(
            ...
            &[
                ...
                (
                    PeriodId::quarter(2025, 2),
                    AmountOrScalar::scalar(2_200_000.0),
                ),
            ],
        )
        ...
        .value(
            ...
            &[
                ...
                (
                    PeriodId::quarter(2025, 2),
                    AmountOrScalar::scalar(1_600_000.0),
                ),
            ],
        )
        .value(
        ...
        .value(
            ...
            &[
                ...
                (
                    PeriodId::quarter(2025, 2),
                    AmountOrScalar::scalar(850_000.0),
                ),
            ],
        )
        .compute(
            "total_opex",
            "sales_marketing + research_development + general_admin",
        )?
        // ─── Operating Income ───
