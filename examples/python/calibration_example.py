...
def main():
    ...
    calibrator = finstack.calibration.CalibrationOrchestrator(base_date, finstack.Currency.USD)
    print("   Orchestrator created")
    
    # Combine all quotes
    all_quotes = rate_quotes + credit_quotes + inflation_quotes + vol_quotes + tranche_quotes
    ...
    try:
        ...
        print(f"   • Curves calibrated: {len(calibration_report.metadata.get('stages', '').split(','))}")
        ...
        print("   The framework structure is in place and ready for full implementation")
