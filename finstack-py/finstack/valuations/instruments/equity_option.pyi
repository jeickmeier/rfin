...
class EquityOptionBuilder:
    ...
    def contract_size(self, contract_size: float) -> "EquityOptionBuilder": ...
    def day_count(self, day_count: Union[DayCount, str]) -> "EquityOptionBuilder": ...
    ...
    def div_yield_id(self, div_yield_id: Optional[str] = ...) -> "EquityOptionBuilder": ...
