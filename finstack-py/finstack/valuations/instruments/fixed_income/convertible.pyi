...
class ConvertibleBondBuilder:
    ...
    def credit_curve(self, credit_curve: str) -> "ConvertibleBondBuilder": ...
    def settlement_days(self, settlement_days: int) -> "ConvertibleBondBuilder": ...
    def recovery_rate(self, recovery_rate: float) -> "ConvertibleBondBuilder": ...
