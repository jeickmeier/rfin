...
class InterestRateFutureBuilder:
    ...
    def currency(self, currency: str | Currency) -> InterestRateFutureBuilder: ...
    ...
    def discount_curve(self, curve_id: str) -> InterestRateFutureBuilder: ...
    def disc_id(self, curve_id: str) -> InterestRateFutureBuilder:
        """Deprecated: use :meth:`discount_curve` instead."""
        ...
    def forward_curve(self, curve_id: str) -> InterestRateFutureBuilder: ...
    def fwd_id(self, curve_id: str) -> InterestRateFutureBuilder:
        """Deprecated: use :meth:`forward_curve` instead."""
        ...
    def position(self, position: str | None = ...) -> InterestRateFutureBuilder: ...
    def day_count(self, day_count: DayCount | str) -> InterestRateFutureBuilder: ...
    ...
    def tick_value(self, tick_value: float | None = ...) -> InterestRateFutureBuilder: ...
    def delivery_months(self, delivery_months: int) -> InterestRateFutureBuilder: ...
    def convexity_adjustment(self, convexity_adjustment: float | None = ...) -> InterestRateFutureBuilder: ...
    def vol_surface(self, vol_surface: str | None = ...) -> InterestRateFutureBuilder: ...
