...
class ExposureDiagnostics:
    ...
    def __init__(self, market_roll_failures: int, valuation_failures: int, total_time_points: int) -> None: ...
    @property
...
class StochasticExposureConfig:
    ...
    def seed(self) -> int: ...
    @property
    def pfe_quantile(self) -> float: ...
    def __repr__(self) -> str: ...

class StochasticExposureProfile:
    ...
    @property
    def pfe_profile(self) -> list[float]: ...
    @property
