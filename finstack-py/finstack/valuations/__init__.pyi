...
class PricerRegistry:
    ...
    def price_with_metrics(self, instrument: object, model: ModelKey | str, market: MarketContext, metrics: list[MetricId | str]) -> ValuationResult: ...
    def asw_forward(self, bond: object, market: MarketContext, forward_curve: str, float_margin_bp: float, dirty_price_ccy: float | None = ...) -> tuple[float, float]: ...
...
class Abs:
    @classmethod
    def from_json(cls, data: str | dict[str, object]) -> "Abs": ...
    @property
    def instrument_id(self) -> str: ...
    @property
    def instrument_type(self) -> InstrumentType: ...
...
class Clo:
    @classmethod
    def from_json(cls, data: str | dict[str, object]) -> "Clo": ...
    @property
    def instrument_id(self) -> str: ...
    @property
    def instrument_type(self) -> InstrumentType: ...
