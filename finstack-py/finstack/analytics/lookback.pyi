...
def mtd_select(dates: list[date], ref_date: date, offset_days: int = 0) -> tuple[int, int]:
    """Month-to-date index range into ``dates``."""
    ...

def qtd_select(dates: list[date], ref_date: date, offset_days: int = 0) -> tuple[int, int]:
    """Quarter-to-date index range into ``dates``."""
    ...

def ytd_select(dates: list[date], ref_date: date, offset_days: int = 0) -> tuple[int, int]:
