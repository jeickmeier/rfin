...
class MissingCurveError(ConfigurationError): ...
class MissingFxRateError(ConfigurationError): ...
class InvalidConfigError(ConfigurationError): ...
class ComputationError(FinstackError): ...
class ConvergenceError(ComputationError): ...
class CalibrationError(ComputationError): ...
class PricingError(ComputationError): ...
...
class InternalError(FinstackError): ...
