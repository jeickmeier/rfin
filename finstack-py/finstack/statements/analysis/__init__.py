...
_warnings.warn(
    "finstack.statements.analysis is deprecated. "
    "Use finstack.statements_analytics.analysis instead.",
    DeprecationWarning,
    stacklevel=2,
)
...
_rust_mod = _finstack.statements.analysis
...
_sys.modules[__name__] = _sys.modules.get("finstack.statements_analytics.analysis", _rust_mod)
