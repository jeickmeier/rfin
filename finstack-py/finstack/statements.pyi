...
class NodeSpec:
    ...
    def with_values(self, values: Dict[PeriodId, AmountOrScalar] | List[Tuple[PeriodId, AmountOrScalar]]) -> NodeSpec: ...
...
class ExtensionRegistry:
    ...
    def execute_all(
        self, model: FinancialModelSpec, results: Results
...
class MetricRegistry:
    def __init__(
        self, namespace: str, metrics: List[MetricDefinition], schema_version: Optional[int] = 1
    ) -> None: ...
    @property
