...
class VolatilityIndexCurve:
    """Forward volatility index curve."""
...
class PriceCurve:
    ...
    def price_on_date(self, date: str | date) -> float: ...
    def bumped_parallel(self, bump: float) -> PriceCurve: ...
    def bumped_percentage(self, pct: float) -> PriceCurve: ...
    def roll_forward(self, days: int) -> PriceCurve: ...
    def __repr__(self) -> str: ...

class FlatCurve:
    """Flat discount curve with a constant continuously compounded rate."""

    def __init__(self, rate: float, base_date: str | date, day_count: str | DayCount, id: str) -> None: ...
    @property
    def id(self) -> str: ...
    @property
    def rate(self) -> float: ...
