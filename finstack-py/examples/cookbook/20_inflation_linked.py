...
Persona: Fixed Income Analyst
Complexity: Intermediate
Runtime: ~1-2 seconds

Description:
Inflation-Linked Bonds example demonstrating key concepts.
...
def main():
    print("COOKBOOK EXAMPLE 20: Inflation-Linked Bonds")
    print("="*60)
    print()
    print("This example demonstrates Inflation-Linked Bonds.")
