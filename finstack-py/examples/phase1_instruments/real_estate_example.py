...
def main():
    ...
    print(f"Method:             Direct Capitalization")
    ...
    print(f"Method:             Discounted Cashflow")
    ...
    print(f"\nDCF accounts for:")
    print(f"  - Below-market NOI in early years")
    print(f"  - Growth to stabilization")
    print(f"  - Higher exit cap rate risk")
    print("=" * 70)
