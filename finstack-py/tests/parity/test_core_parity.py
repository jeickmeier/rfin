...
class TestCurrencyParity:
    ...
    def test_currency_construction(self):
...
class TestMoneyParity:
    ...
    def test_money_construction(self):
...
class TestDayCountParity:
    ...
    def test_act360_year_fraction(self):
    ...
    def test_act365f_year_fraction(self):
    ...
    def test_thirty360_year_fraction(self):
    ...
    def test_day_count_days_method(self):
...
class TestPeriodParity:
    ...
    def test_period_id_monthly(self):
    ...
    def test_period_id_quarterly(self):
    ...
    def test_period_id_annual(self):
    ...
    def test_build_periods_quarterly(self):
    ...
    def test_build_periods_monthly(self):
    ...
    def test_build_periods_with_actuals(self):
        """Test building periods with actuals cutoff."""
        plan = build_periods("2024Q1..Q4", "2024Q2")
        
        assert len(plan.periods) == 4
        # Q1 and Q2 should be actual, Q3-Q4 forecast
        assert plan.periods[0].is_actual == True
        assert plan.periods[1].is_actual == True
        assert plan.periods[2].is_actual == False
        assert plan.periods[3].is_actual == False


class TestDiscountCurveParity:
    """Test discount curve operations match Rust."""

    def test_discount_curve_construction(self):
    ...
    def test_discount_factor_at_knot(self):
    ...
    def test_zero_rate_consistency(self):
...
class TestForwardCurveParity:
    ...
    def test_forward_curve_construction(self):
    ...
    def test_forward_rate_at_knot(self):
...
class TestFxMatrixParity:
    ...
    def test_fx_matrix_direct_quote(self):
    ...
    def test_fx_matrix_inverse_quote(self):
    ...
    def test_fx_matrix_same_currency(self):
    ...
    def test_fx_matrix_triangulation(self):
...
class TestMarketContextParity:
    ...
    def test_market_context_insert_discount(self):
    ...
    def test_market_context_insert_forward(self):
    ...
    def test_market_context_as_of_date(self):
...
class TestEdgeCases:
    ...
    def test_money_large_values(self):
    ...
    def test_money_small_values(self):
    ...
    def test_day_count_same_date(self):
    ...
    def test_discount_curve_zero_time(self):
    ...
    def test_fx_matrix_zero_rate(self):
