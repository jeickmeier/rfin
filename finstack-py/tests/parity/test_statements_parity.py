...
class TestModelBuilderParity:
    ...
    def test_builder_with_actuals(self):
        ...
        assert model.periods[0].is_actual == True
        assert model.periods[1].is_actual == True
        assert model.periods[2].is_actual == False
        assert model.periods[3].is_actual == False
    ...
    def test_builder_with_formula(self):
    ...
    def test_builder_with_forecast(self):
...
class TestEvaluatorParity:
    ...
    def test_evaluator_formula_evaluation(self):
    ...
    def test_evaluator_precedence_value_over_formula(self):
    ...
    def test_evaluator_precedence_value_over_forecast(self):
...
class TestForecastSpecParity:
    ...
    def test_lognormal_distribution_forecast(self):
...
class TestRegistryParity:
    ...
    def test_has_metric(self):
        ...
        assert registry.has_metric("fin.gross_margin") == True
        assert registry.has_metric("nonexistent.metric") == False
...
class TestExtensionsParity:
    ...
    def test_corkscrew_extension(self):
        """Test corkscrew extension."""
        from finstack.statements.extensions import CorkscrewExtension, CorkscrewConfig
    ...
    def test_credit_scorecard_extension(self):
...
class TestCapitalStructureParity:
    ...
    def test_add_bond_to_model(self):
    ...
    def test_add_swap_to_model(self):
...
class TestEdgeCases:
    ...
    def test_single_period_model(self):
...
class TestDeterminismParity:
    ...
    def test_forecast_with_seed_is_deterministic(self):
