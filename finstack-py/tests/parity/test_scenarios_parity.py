...
class TestScenarioSpecParity:
    ...
    def test_scenario_spec_construction(self):
    ...
    def test_scenario_spec_with_operations(self):
    ...
    def test_scenario_spec_priority(self):
...
class TestOperationSpecParity:
    ...
    def test_curve_parallel_bp_operation(self):
    ...
    def test_curve_node_bp_operation(self):
    ...
    def test_time_roll_forward_operation(self):
...
class TestScenarioEngineParity:
    ...
    def test_apply_curve_parallel_shock(self):
...
class TestCurveKindParity:
    ...
    def test_curve_kind_values(self):
...
class TestTenorMatchModeParity:
    ...
    def test_tenor_match_mode_values(self):
...
class TestDSLParity:
    ...
    def test_dsl_parse_curve_shift(self):
    ...
    def test_dsl_parse_multiple_operations(self):
    ...
    def test_dsl_parse_with_comments(self):
    ...
    def test_dsl_parse_roll_forward(self):
...
class TestScenarioBuilderParity:
    ...
    def test_builder_multiple_operations(self):
...
class TestEdgeCases:
    ...
    def test_zero_basis_point_shift(self):
    ...
    def test_large_shock_magnitude(self):
    ...
    def test_scenario_composition_same_priority(self):
...
class TestSerializationParity:
    ...
    def test_scenario_spec_to_json(self):
    ...
    def test_scenario_spec_from_json(self):
