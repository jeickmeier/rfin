...
def test_real_estate_direct_cap() -> None:
...
def test_real_estate_direct_cap_with_schedule() -> None:
...
def test_real_estate_dcf_with_appraisal() -> None:
...
def test_real_estate_repr() -> None:
...
def test_real_estate_invalid_noi_schedule() -> None:
