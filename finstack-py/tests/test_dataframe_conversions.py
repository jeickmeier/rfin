...
class TestDataFrameConversions:
    ...
    def test_valuation_result_to_polars(self):
    ...
    def test_portfolio_valuation_to_polars(self):
        """Test PortfolioValuation to_polars() instance method."""
        pass

    def test_portfolio_valuation_entities_to_polars(self):
        """Test PortfolioValuation entities_to_polars() instance method."""
        pass

    def test_statements_results_to_polars_long(self):
        """Test Statements Results to_polars_long() method."""
        pass

    def test_statements_results_to_polars_wide(self):
    ...
    @pytest.mark.skipif(not HAS_POLARS, reason="polars not installed")
    def test_polars_io_csv(self, tmp_path):
    ...
    @pytest.mark.skipif(not HAS_POLARS, reason="polars not installed")
    def test_polars_io_parquet(self, tmp_path):
    ...
    def test_pandas_io_csv(self, tmp_path):
    ...
    @pytest.mark.skipif(not (HAS_POLARS and HAS_PANDAS), reason="polars/pandas not installed")
    def test_pandas_io_parquet(self, tmp_path):
...
class TestDataFrameSchema:
    ...
    def test_portfolio_positions_schema(self):
    ...
    def test_portfolio_entities_schema(self):
    ...
    def test_statements_long_schema(self):
    ...
    def test_statements_wide_schema(self):
