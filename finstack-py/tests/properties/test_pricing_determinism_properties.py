...
@st.composite
def discount_curve_strategy(draw, currency_code="USD"):
...
@st.composite
def deposit_strategy(draw, currency_code="USD"):
...
@st.composite
def bond_strategy(draw, currency_code="USD"):
...
class TestPricingDeterminism:
    ...
    def test_pricing_twice_identical_deposit(self, deposit, curve):
    ...
    def test_pricing_twice_identical_bond(self, bond, curve):
    ...
    @given(deposit_strategy(), discount_curve_strategy())
    @settings(max_examples=50, deadline=None)
    def test_repeated_pricing_stable(self, deposit, curve):
    ...
    @settings(max_examples=30, deadline=None)
    def test_pricing_order_independent(self, deposits, curve):
...
class TestMarketContextImmutability:
    ...
    @settings(max_examples=50, deadline=None)
    def test_market_context_reusable(self, curve, deposit):
    ...
    @settings(max_examples=30, deadline=None)
    def test_curve_insertion_order_independent(self, curves):
...
class TestPricingReproducibility:
    ...
    @settings(max_examples=30, deadline=None)
    def test_pricing_reproducible_across_iterations(self, deposit, curve, num_iterations):
    ...
    def test_bond_pricing_stable(self, bond, curve):
...
class TestMetricsDeterminism:
    ...
    @given(deposit_strategy(), discount_curve_strategy())
    @settings(max_examples=30, deadline=None)
    def test_metrics_deterministic(self, deposit, curve):
        ...
        result1 = registry.price_deposit_with_metrics(
            deposit, "discounting", market, ["accrued", "ytm"]
        )
        result2 = registry.price_deposit_with_metrics(
            deposit, "discounting", market, ["accrued", "ytm"]
        )
    ...
    @given(bond_strategy(), discount_curve_strategy())
    @settings(max_examples=20, deadline=None)
    def test_bond_metrics_stable(self, bond, curve):
        ...
        try:
            ...
            for _ in range(3):
                result = registry.price_bond_with_metrics(
                    bond, "discounting", market, ["clean_price", "accrued"]
                )
