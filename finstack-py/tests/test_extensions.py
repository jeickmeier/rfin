...
class TestCorkscrewAccount:
    ...
    def test_create_with_changes(self):
        ...
        account = CorkscrewAccount(
            "cash", AccountType.ASSET, changes=["cash_inflows", "cash_outflows"]
        )
        assert account.changes == ["cash_inflows", "cash_outflows"]

    def test_create_with_beginning_balance(self):
        """Test creating account with beginning balance override."""
        account = CorkscrewAccount(
            "cash", AccountType.ASSET, beginning_balance_node="opening_cash"
        )
...
class TestCorkscrewConfig:
    ...
    def test_create_with_accounts(self):
        ...
        accounts = [
            ...
            CorkscrewAccount(
                "debt", AccountType.LIABILITY, changes=["debt_issuance"]
            ),
        ]
    ...
    def test_create_with_fail_on_error(self):
...
class TestScorecardMetric:
    ...
    def test_create_with_thresholds(self):
        ...
        metric = ScorecardMetric(
            "debt_to_ebitda", "total_debt / ebitda", thresholds=thresholds
        )
...
class TestScorecardConfig:
    ...
    def test_create_with_rating_scale(self):
    ...
    def test_create_with_min_rating(self):
    ...
    def test_json_roundtrip(self):
        ...
        config1 = ScorecardConfig(
            rating_scale="Moody's", metrics=metrics, min_rating="Baa"
        )
        json_str = config1.to_json()
...
class TestExtensionMetadata:
    ...
    def test_create_with_description(self):
        ...
        metadata = ExtensionMetadata(
            "test_extension", "1.0.0", description="Test extension"
        )
    ...
    def test_create_with_author(self):
        ...
        metadata = ExtensionMetadata(
            "test_extension", "1.0.0", author="Test Author"
        )
