...
name: bug-hunting
description: >-
  Use when you want to find and fix bugs in a codebase through a systematic, multi-pass process that combines automated scanning with fresh eyes manual
  review to converge on clean, production-ready code.
---
